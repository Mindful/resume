...
\newcommand{\projectParasite}{
	...
	{一週間当たりにプレイされた回数が2百万回に達したStarCraft 2のMODである。専用のGUIプログラミング言語とGalaxyというC言語系プログラミング言語で開発を行った。一人で設計とデザインを考え出し、コードの大部分も一人で書いた。後でもう一人の開発者と二人のコミュニティ管理者でチームを結成した。}\iftoggle{long}{}{\\[0.5\baselineskip]}
}
