...
\begin{document}
	...
	\iftoggle{long}{ % --------------------------- LONG -----------------------------------
		...
		\majorsection{\skills} \littlelinebreak
		...
		\begin{minipage}{0.45\textwidth}
				...
				\begin{tabular}{l}
					...
					\skilljapanese
				\end{tabular}
		\end{minipage} \\\littlelinebreak
		
		\majorsection{\projects} \littlelinebreak
		
		\begin{itemize}[noitemsep,topsep=0pt]
			\item \projectParasite
			\item \projectPytext
		\end{itemize}
		
		\majorsection{\awards} \littlelinebreak
		
		\begin{itemize}[noitemsep,topsep=0pt]
			\item \awardGoldenTicket
			\item \awardEbayApi
		\end{itemize}
