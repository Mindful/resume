...
\newcommand{\skilljapanese}{\mlt{Japanese - Fluent (JLPT N1)}{日本語 - 流暢　(日本語能力試験N1合格)}}
...
\begin{document}
	...
	\hfill
	\begin{minipage}{.3\textwidth}
		\fixedphonesymbol \phonenumber \\
		\emailsymbol \email \\
		\githubsocialsymbol \github \\
		\linkedinsocialsymbol \linkedin \\
	\end{minipage}
	\iftoggle{photo}{
		\begin{minipage}{.3\textwidth}
			\begin{flushright}
