...
\newcommand{\mlt}[2]{
	\iftoggle{en}{#1}{}
	\iftoggle{ja}{\begin{CJK}{UTF8}{min}#2\end{CJK}}{}
}
...
\resumesection{\mlt{Experience}{職務経歴}}
\resumesection{\mlt{Projects}{個人開発}}
\resumesection{\mlt{Awards}{受賞歴}}
\resumesection{\mlt{Education}{学歴}}
