...
% ---------------
	...
	\newcommand{\mlt}[2]{\iftoggle{en}{#1}{}\iftoggle{ja}{\begin{CJK}{UTF8}{min}#2\end{CJK}}{}}
	...
	\begin{document}
		...
		\iftoggle{photo}{
			...
			\majorsection{\mlt{Experience}{職務経歴}}
				...
				\end{itemize}
			\majorsection{\mlt{Projects}{個人開発}}
			\majorsection{\mlt{Awards}{受賞歴}}
			\majorsection{\mlt{Skills \& Languages}{技術・言語}}
			\majorsection{\mlt{Education}{学歴}}
