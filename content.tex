...
\newcommand{\jobexpOctanoveIntern}{
	...
	{\mlt{Current}{現在}}
	%TODO: no JP, also needs update once I finish
	{\begin{itemize}[noitemsep]
		\item Train multilingual multitask seq2seq machine learning model to perform translation, grammatical error correction and other language learning related tasks
...
\newcommand{\jobexpGDIIntern}{
	...
	{\begin{itemize}[noitemsep]
		\item \mlt{Took ownership of and greatly expanded the functionality of a Ruby on Rails application automating Hadoop permissions changes and other operational tasks,  saving tens of hours of work per week}
...
\newcommand{\educationUW}{
	\education{\mlt{University of Washington}{ワシントン大学}}{\mlt{2019/9 – 2022/10}{2019年9月 – 2022年10月}}{\mlt{M.S.}{理学修士}}
