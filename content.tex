...
\newcommand{\ebayItemJava}{\item \mlt{Maintained and developed new features in Java/Spring services at scale (several million requests per hour), wrote tests using JUnit and Mockito}{JavaとSpringで大規模（毎時数百万のリクエスト )なウェブサービスにおける保守と新機能の開発をし、JUnitとMockitoを利用してその自動テストも開発}}
