...
\newcommand{\jobexpMantra}{
	...
	{\begin{itemize}[noitemsep]
			\item \mlt{Lead efforts to improve manga translation system, including training large language models and applying glossary-aware translation, using Pytorch}{arg2}
			\item \mlt{Defined company practices for information security and engineer hiring}{arg2}
			\item \mlt{Rewrote language learning IOS application from scratch in Flutter }{arg2}
			\item \mlt{Implemented language learning features in Django backend, such as spaced repetition and multiword expression detection}{arg2}
	\end{itemize}}
}
...
\newcommand{\jobexpNLPConsultant}{
	...
	{\mlt{Current}{現在}}
	{\begin{itemize}[noitemsep]
		\item \mlt{Lead development of an interactive translation system allowing users to choose from likely output words at each decoding step of Huggingface transformer models.}{arg2}
		\item \mlt{Implemented the optimized character-level transformer from Google's CANINE paper in PyTorch and \href{https://github.com/octanove/shiba}{released pre-trained models for Japanese}}{ググルの「CANINE」論文の超効率トランスフォーマーをPyTorchで実装し、\href{https://github.com/octanove/shiba}{事前学習されたモデルを公開}}
...
\newcommand{\jobexpUTokyoIntern}{
	...
	{\mlt{2020/12}{2021年12月}}
	{\begin{itemize}[noitemsep]
			\item \mlt{Research into deep learning approaches to explainable grammatical error correction, word sense disambiguation and definition generation}{arg2}
	\end{itemize}}
}
...
\newcommand{\extraParasite}{
	\extra{Parasite}
	{\mlt{2009}{2009年}}
	{\mlt{Lead development of a StarCraft 2 mod which reached two million plays per week.}{一週間当たりにプレイされた回数が2百万回に達したStarCraft 2のMODを開発し、その後維持するためにもう一人の開発者と二人のコミュニティ管理者でチームを結成した。}}
}
...
\newcommand{\extraInnovationExpo}{
		\extra{\mlt{Internal Expo Presenter}{社内博覧会の発表者に選出}}
		{\mlt{2016/06}{2016年06月}} %on the 24th
		{\mlt{Hackathon project converting relevant n-grams into affiliate links featured in eBay's internal expo (14\% acceptance rate).}
...
\newcommand{\papermweaswsd}{
	\paper{MWE as WSD: Solving Multiword Expression Identification with Word Sense Disambiguation}{\textbf{J Tanner}, J Hoffman}{\href{https://arxiv.org/abs/2303.06623}{arXiv preprint}}{[in review]}
}

\newcommand{\papergrammartagger}{
	\paper{GrammarTagger: A Multilingual, Minimally-Supervised Grammar Profiler for Language Education}{M Hagiwara, \textbf{J Tanner}, K Sakaguchi}{\href{https://arxiv.org/abs/2104.03190}{arxiv preprint}}{}
}
