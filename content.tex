...
\newcommand{\jobexpMantra}{
	...
	{\begin{itemize}[noitemsep]
			\item \mlt{	Mentor engineers working on manga translation system, improving BLEU score on multiple languages by $>$10 via projects including: 
				\begin{itemize}[noitemsep]
					\item Training multilingual and terminology-aware translation models with Fairseq
					\item Training LoRA adapters and engineering prompts for large language models using Pytorch \& LangChain
					\item Investigating methods to automatically detect bad translations
			\end{itemize}}{arg2}
			\item \mlt{Defined and implemented company policy for engineer hiring, reducing interviews per hire by more than 50\%}{arg2}
...
\newcommand{\papermweaswsd}{
	\paper{MWE as WSD: Solving Multiword Expression Identification with Word Sense Disambiguation}{\textbf{J Tanner}, J Hoffman}{Currently in review}{https://openreview.net/pdf?id=qWlU7Y8BF4S}
}
