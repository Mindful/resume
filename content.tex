...
\newcommand{\academicservice}{\mlt{Academic Service}{学術活動}}
...
\newcommand{\header}[1]{
	...
	\begin{tabularx}{\textwidth}{@{}lX@{}}
		\begin{minipage}{0.5\linewidth}
			...
			#1
		\end{minipage} &
		\hspace*{-6.5em}% ← shift the table left
		\begin{tabular}{l@{\hspace{5pt}}l@{\hspace{2em}}l@{\hspace{5pt}}l}
			\faGlobe & https://joshuatanner.dev/ &
			\faLinkedin & linkedin.com/in/joshuatanner2 \\
			\faEnvelope & mindful.jt@gmail.com &
			\faGithub & github.com/joshuatanner/ \\
		\end{tabular}
	\end{tabularx}
	\rule{\linewidth}{1pt}
}
...
\newcommand{\jobexpMantra}{
	...
	{\begin{itemize}[noitemsep]
			...
			\end{itemize}
			\item \mlt{Develop mobile application backend using Django and AWS}{DjangoとAWSを使用してモモバイルアプリケーションのバックエンドを開発・保守}
...
\newcommand{\ebayItemScheduler}{\item \mlt{Lead development of, tested, and owned Scala distributed scheduler that powered proactive messaging for eBay's chat bot and Chinese iPhone app}{eBayのチャットボットと中国版iPhoneアプリの自発的なメッセージを送信するScalaの分散スケジューラとその自動テストの開発を率い、保守}}
...
\newcommand{\projectParasite}{
	\project{Parasite}
	{\mlt{2009}{2009年}}
	{\mlt{Lead development of StarCraft 2 mod reaching more than a million plays per week}{一週間当たりにプレイされた回数が100万回以上に達したStarCraft 2のMODを開発し、その後維持するためにもう1人の開発者と2人のコミュニティ管理者でチームを結成}}
}

% Interpreter work

\newcommand{\interpexpAcen}{
	\interpretingexperience{Anime Central 2025}
	{\mlt{2025/5}{2025年5月}}
	{\mlt{Consecutive Interpretation}{逐次通訳}}
	{\mlt{Accompanied illustrator and animator Akio Watanabe, interpreting panels and conversations with event staff}{イラストレーター・アニメーターのの渡辺明夫に同行し、パネルセッションやイベントスタッフとの会話を通訳}}
}


\newcommand{\interpexpSakuraconThree}{
	\interpretingexperience{Sakura-Con 2025}
	{\mlt{2025/4}{2025年4月}}
	{\mlt{Consecutive Interpretation}{逐次通訳}}
	{\mlt{Accompanied band Hitsujibungaku, interpreting press interviews and conversations with event staff}{バンドの羊文学に同行し、取材やイベントスタッフとの会話を通訳}}
	
}

\newcommand{\interpexpSakuraconTwo}{
	\interpretingexperience{Sakura-Con 2024}
	{\mlt{2024/3}{2024年3月}}
	{\mlt{Consecutive Interpretation}{逐次通訳}}
...
{\mlt{Mantra Inc.}{Mantra株式会社}}
{\mlt{2021/12 - 2024/5}{2021年12月 - 2024年5月}}
{{\mlt{Interpretation \& Translation}{逐次通訳と翻訳}}}
{\mlt{As a software engineer developing automatic Manga translation:}{漫画の自動翻訳を開発するエンジニアとして}
		\begin{itemize}[noitemsep]
			\item \mlt{Produce technical documentation in Japanese and English}{日本語と英語で技術文書を作成}
			\item \mlt{Collaborate with translators to design and implement translation evaluation}{翻訳者と連携し、翻訳の評価制度を設計・導入}
			\item \mlt{Translate business communications}{メールや広報文書を翻訳}
			\item \mlt{Interpret conversations between other staff}{社員間の会話を通訳}
		\end{itemize}
}}

\newcommand{\interpexpCrunchyrollTwo}{
	\interpretingexperience{Crunchyroll Expo 2022}
	{\mlt{2022/9}{2022年9月}}
	{\mlt{Consecutive Interpretation}{逐次通訳}}
	{\mlt{Accompanied band ATARASHII GAKKO!, interpreting press interviews and conversations with event staff}
		{バンドのATARASHII GAKKO!に同行し、取材やイベントスタッフとの会話を通訳}}
}

\newcommand{\interpexpCrunchyrollOne}{
	\interpretingexperience{Crunchyroll Expo 2019}
	{\mlt{2019/9}{2019年9月}}
	{\mlt{Consecutive Interpretation}{逐次通訳}}
	...
	{作曲家の高梨康治に同行し、パネルセッション、取材やイベントスタッフとの会話を通訳}}
}
...
\newcommand{\interpexpSakuraconOne}{
	\interpretingexperience{Sakura-Con 2019}
	{\mlt{2019/4}{2019年4月}}
	{\mlt{Consecutive Interpretation}{逐次通訳}}
...
\newcommand{\papercoam}{
	\paper{CoAM: Corpus of All-Type Multiword Expressions}{Y Ide, \textbf{J Tanner}, A Noheji, J Hoffman, J Vasselli}{ACL 2025 (Upcoming)}{https://arxiv.org/abs/2412.18151/}
}

\newcommand{\papermangatranslationllm}{
	\paper{Context-Informed Machine Translation of Manga using Multimodal Large Language Models}{P Lippmann, K Skublicki, \textbf{J Tanner}, S Ishiwatari, J Yang}{COLING 2025 Oral}{https://aclanthology.org/2025.coling-main.232/}
}
...
\newcommand{\papermosla}{
	\paper{Project MOSLA: Recording Every Moment of Second Language Acquisition}{M. Hagiwara, \textbf{J Tanner}}{LREC-COLING 2024 Oral}{https://aclanthology.org/2024.lrec-main.1147/}
}
...
\newcommand{\educationHyogo}{
	\education{\mlt{University of Hyogo}{兵庫県立大学}}{\mlt{2014 -- 2015}{2014年 -- 2015年}}{\mlt{Exchange Program}{交換留学}}
...
\newcommand{\educationToudai}{ % 2020/12 - 2021/12
	\education{\mlt{University of Tokyo}{東京大学}}{\mlt{2020 -- 2021}{2020年 -- 2021年}}{\mlt{Research Internship}{研究実習}}
	{\mlt{Natural language processing research at the Institute of Industrial Science}{東京大学生産技術研究所で自然言語処理の研究}}
}
