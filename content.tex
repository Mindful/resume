...
\newcommand{\awardsprojects}{\mlt{Awards \& Projects}{学業}}
...
\newcommand{\jobexpMantra}{
	...
	{\begin{itemize}[noitemsep]
			\item \mlt{Lead projects applying large language models, }{arg2}
	\end{itemize}}
}
...
\newcommand{\ebayItemRevminer}{\item \mlt{Research implementing a bootstrapping NLP process to extract informative noun/adjective pairs from product reviews was accepted for presentation at internal research conference (25\% acceptance rate)}{PythonでspaCyを利用し、商品レビューから有用な名詞と形容詞の組み合わせを抽出するブートストラップ自然言語処理を実装}}
...
\newcommand{\projectParasite}{
	...
	{\mlt{2009}{2009年}}
	{\mlt{Lead development of a StarCraft 2 mod which at peak averaged two million plays per week.}{一週間当たりにプレイされた回数が2百万回に達したStarCraft 2のMODを開発し、その後維持するためにもう一人の開発者と二人のコミュニティ管理者でチームを結成した。}}
}
...
\newcommand{\awardGoldenTicket}{
		...
		{\mlt{2016/06}{2016年06月}}
		{\mlt{Hackathon project converting relevant n-grams into affiliate links chosen for presentation at internal innovation expo (14\% acceptance rate).}
