...
\newcommand{\extraResolve}{
	...
	{Multiword-expression aware dictionary for language learners using models trained with Pytorch Lightning and gRPC for backend}
}
...
\newcommand{\papermangatranslationlongcontext}{
	\paper{Using Long Context for Manga Machine Translation}{H Kaino, T Kajiwara, T Ninomiya, \textbf{J Tanner}, S Ishiwatari}{Currently in review}{}
}
