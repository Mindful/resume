...
\newcommand{\jobexpMantra}{
	...
	{\begin{itemize}[noitemsep]
			\item \mlt{Lead NLP engineering efforts across multiple machine translation projects including: 
				\begin{itemize}[noitemsep]
...
%				\item Explore LLM fine-tuning methods to improveinl translation performance
				\item Build multi-step LLM pipeline for full novel translation, translating >150 novels
				\item Train multilingual and terminology-aware translation models with Fairseq, improving BLEU on multiple languages by $>$10
				\item Manage professional translators to optimize human evaluation and post-editing for manga translation systems
			\end{itemize}}{arg2}
			\item \mlt{Coordinate with external clients to integrate Mantra's translation engine into their systems}{arg2}
