...
\newcommand{\jobexpMantra}{
	\jobexperience{\mlt{NLP Lead}{NLP Lead}}
	{\mlt{Development Team}{開発チーム}}
	{\mlt{Mantra Inc}{Mantra株式会社}}
	{\mlt{2021/12}{2021年12月}}
	{\mlt{Current}{現在}}
	{\begin{itemize}[noitemsep]
			\item \mlt{Lead NLP engineering (5 engineers) across multiple projects: 
				\begin{itemize}[noitemsep]
				\item Apply LLMs to manga translation, allowing terminology and story aware translation of >30k manga chapters
%				\item Explore LLM fine-tuning methods to improveinl translation performance
				\item Build multi-step LLM pipeline for novel translation with LangChain to partially automate translation of >150 novels
				\item Integrate Mantra's translation technology into multiple multi-billion dollar companies
				\item Train multilingual and terminology-aware translation models with Fairseq, improving BLEU on multiple languages by $>$10
				\item Work with professional translators to improve evaluation
			\end{itemize}}{arg2}
			\item \mlt{Develop and maintain application backend using Django and AWS}{arg2}
			\item \mlt{Rewrite flagship mobile application from scratch in Flutter}{arg2}
	\end{itemize}}
}
...
\newcommand{\extraResolve}{
	\extra{MWE Dictionary}
	{Personal Project / 2023}
	{Multiword-expression aware dictionary for language learners using models trained with Pytorch Lightning and a gRPC backend}
}
...
\newcommand{\papermweaswsd}{
	\paper{MWE as WSD: Solving Multiword Expression Identification with Word Sense Disambiguation}{\textbf{J Tanner}, J Hoffman}{EMNLP Findings+Poster 2023}{https://arxiv.org/abs/2303.06623}
}

\newcommand{\papermosla}{
	\paper{Project MOSLA: Recording Every Moment of Second Language Acquisition}{M. Hagiwara, \textbf{J Tanner}}{LREC-COLING 2024 (forthcoming)}{}
}

\newcommand{\papermangatranslationlongcontext}{
	\paper{Utilizing Longer Context than Speech Bubbles in Automated Manga Translation}{H Kaino, S Sugihara, T Kajiwara, T Ninomiya, \textbf{J Tanner} and S Ishiwatari}{LREC-COLING 2024 (forthcoming)}{}
}
