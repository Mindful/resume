...
\newcommand{\jobexpMantra}{
	...
	{\begin{itemize}[noitemsep]
			\item \mlt{Lead NLP engineering efforts across multiple machine translation projects including: 
				...
				\item Explore LLM fine-tuning methods to improve translation performance
				...
				\item Coordinate with professional translators to optimize human evaluation and post-editing for manga translation systems
			\end{itemize}}{arg2}
