...
\newcommand{\jobexpOctanoveIntern}{
	...
	{\begin{itemize}[noitemsep]
		\item Train multilingual multitask seq2seq machine learning model to perform translation, grammatical error correction and other language learning related tasks using fairseq
		\item Implement an ensemble of language identification models to clean and filter data with heavy code switching
	\end{itemize}}
}

%-------------eBay---------------------

%TODO: change this so it's clear I was leading development of the scheduler
\newcommand{\ebayItemScheduler}{\item \mlt{Developed from scratch, wrote tests for, and maintained sole ownership of the Scala distributed scheduler that powered proactive messaging for eBay ShopBot and eBay's Chinese iPhone app}{eBayのチャットボットと中国版iPhoneアプリの自発的なメッセージを送信する分散スケジューラとその自動テストをScalaでゼロから開発し、一人で保守}}
...
%TODO english/JP out of sync slightly
...
\newcommand{\educationUW}{
	\education{\mlt{University of Washington}{ワシントン大学}}{\mlt{2019/9 – 2021/12}{2019年9月 – 2021年12月}}{\mlt{M.S.}{理学修士}}
	{\mlt{(Expected) masters degree in computational linguistics.}{(見込み)計算言語学の修士号}}
}
\newcommand{\educationEvergreen}{
	\education{\mlt{The Evergreen State College}{エバーグリーン州立大学}}{\mlt{2012/9 – 2015/4}{2012年9月 – 2015年4月}}{\mlt{B.S.}{理学士}}
