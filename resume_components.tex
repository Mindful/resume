...
\usepackage{url}
\usepackage{hyperref}
\definecolor{linkDarkBlue}{rgb}{0.0, 0.0, 0.55}
...
\newtoggle{interpreter} % interpreter resume?
...
\newcommand{\award}[1]{
$\bullet$ \raggedright #1 \\[0.3\baselineskip]
}

\newcommand{\education}[4]{
	\noindent{\large\textbf{#3}} \\
	 \iftoggle{interpreter}{\textbf{#1 / #2}\\#4}{#1 / #2}\\[0.3\baselineskip]
}

\newcommand{\paper}[4]{
\noindent{\textbf{#1}}\\#2\\ #3 \ifstrempty{#4}{}{\href{#4}{[link \faExternalLinkSquare*]}} \\[0.3\baselineskip]
}
